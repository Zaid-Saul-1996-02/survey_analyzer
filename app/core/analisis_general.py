...
from utils.read_dcument_util import get_data_excel, pdf_to_text
from utils.model_llm_utils import extraccion_datos, categorizar_clasificar, analisis_1, refact_porque, informe
...
def analisis_general(url_excel:str, url_pdf_esquema:str, url_pdf_context:str)->SalidaFuncion:
    """
    ...
    for cap in range(1,len(list_cap)):
        ...
        for sub_cap in list_cap[cap][1]:
            ...
            texto_extraccion_datos = extraccion_datos(texto_contexto, texto_objetivo, texto_subcapitulo)
            
            texto_categorizar_clasificar = categorizar_clasificar(texto_contexto, texto_objetivo, texto_subcapitulo, texto_extraccion_datos, datos_personales)
        
            texto_analisis = analisis_1(texto_contexto, texto_objetivo, texto_subcapitulo, texto_extraccion_datos, texto_categorizar_clasificar)
